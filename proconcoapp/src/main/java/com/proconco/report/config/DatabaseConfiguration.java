package com.proconco.report.config;
...
@Configuration
@EnableJpaRepositories("com.proconco.report.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.proconco.report.repository.search")
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "com.proconco.report.config.HerokuDatabaseConfiguration")
